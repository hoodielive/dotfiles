...
(use-package org
  ...
  (setq org-agenda-files
	'("~/Clones/dope/Tasks.org"
	  "~/Clones/dope/Enilo.org")))
...
(defun egun/org-mode-visual-fill ()
  (setq visual-fill-column-width 100
	visual-fill-column-center t)
  (visual-fill-column-mode 1))

(use-package visual-fill-column
  :hook (org-mode . egun/org-mode-visual-fill))
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(lsp-mode visual-fill-column org-bullets pdf-tools nim-mode write-room forge evil-magit magit evil-escape counsel-projectile projectile evil-collection ivy-prescient helpful rainbow-delimiters ivy-rich counsel which-key swiper doom-themes doom-modeline))
 '(projectile-completion-system 'ivy))
(custom-set-faces
